...
# Armazenando usuarios e agendamentos durante a simulação
usuarios = {}
agendamentos = []
...
def cadastro():
    ...
    # verificação se já existe e-mail cadastrado
...
def get_horarios(data):
    # armazena os agendamentos e nesta parte verificae/simula os horários ocupados
    horarios_ocupados = []
